...
description: "A quick reference for the different properties available on a .NET Uri object."
pubDate: 2015-05-21
tags: ["c#"]
---

One thing that keeps coming up, but not enough for me to actually remember what I learnt last time, is how to get different parts of a request [Uri](https://msdn.microsoft.com/en-us/library/system.uri%28v=vs.110%29.aspx "MSDN")

So I made a little [console app](https://gist.github.com/AndyA13/147f079cf7d69c55038d "gist.github.com") that outputs the different parts from two example Uris.
